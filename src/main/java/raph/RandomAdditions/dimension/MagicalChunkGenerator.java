...
public class MagicalChunkGenerator extends ChunkGenerator<MagicalChunkGenerator.Config> {

    public MagicalChunkGenerator(IWorld world, BiomeProvider provider) {
