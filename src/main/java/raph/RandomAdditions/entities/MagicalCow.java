...
public class MagicalCow extends CreatureEntity {

	@SuppressWarnings("unchecked")
	public MagicalCow(EntityType<? extends CreatureEntity> type, World worldIn) {
		super((EntityType<? extends CreatureEntity>) ModEntities.MAGICAL_COW, worldIn);
	}
