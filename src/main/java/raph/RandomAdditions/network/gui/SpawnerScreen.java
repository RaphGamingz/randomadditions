package raph.RandomAdditions.network.gui;
...
import raph.RandomAdditions.network.PacketSpawn;
...
public class SpawnerScreen extends Screen {
    ...
    private ResourceLocation GUI = new ResourceLocation(RandomAdditions.MODID, "textures/gui/spawner_gui.png");
